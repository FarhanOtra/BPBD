...
<h4 style="text-indent:30px; line-height:1.5">Pada hari ini <b>{{$hari}}</b> Tanggal <b>{{$tgl}}</b> Bulan <b>{{$bulan}}</b> Tahun <b>{{$thn}}</b> yang bertanda tangan dibawah ini :</h4>
    ...
    <table>
        ...
        <h4 style="line-height:1.5;text-indent:30px;">Dengan ini <b><i>PIHAK PERTAMA<i></b> menyerahkan kepada <b><i>PIHAK KEDUA</i></b> dan <b><i>PIHAK KEDUA</i></b> menerima penyerahan dari <b><i>PIHAK PERTAMA</i></b> sebagai pinjaman untuk <b><i>{{$c->kegiatan}}</b>, dengan rincian sebagai berikut :</h4>
</div>
        <table class="tabel-barang" style="width:520px; border:1px solid black">
            <tr class="tr-barang">
                <th class="td-barang"><h4><b>No</b></h4></th>
                <td class="td-barang"><h4><b>Jenis Barang</b></h4></td>
