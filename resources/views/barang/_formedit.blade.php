<div class="form-group{{ $errors->has('id_barang') ? ' has-danger' : '' }}">
        ...
        <input type="text" name="id_barang" id="input-id_barang" class="form-control form-control-alternative{{ $errors->has('id_barang') ? ' is-invalid' : '' }}" placeholder="{{ __('ID Barang') }}" value="{{$barang->id_barang}}" required autofocus>
    ...
    <div class="form-group{{ $errors->has('nama_barang') ? ' has-danger' : '' }}">
        ...
        <input type="text" name="nama_barang" id="input-nama_barang" class="form-control form-control-alternative{{ $errors->has('nama_barang') ? ' is-invalid' : '' }}" placeholder="{{ __('Nama Barang') }}" value="{{$barang->nama_barang}}" required>
    ...
    <div class="form-group{{ $errors->has('harga_barang') ? ' has-danger' : '' }}">
        ...
        <input type="text" name="harga_barang" id="input-harga_barang" class="form-control {{ $errors->has('harga_barang') ? ' is-invalid' : '' }}" placeholder="{{ __('Harga Barang') }}"  value="{{$barang->harga}}" required>
        </div>
    ...
    <div class="form-group{{ $errors->has('satuan') ? ' has-danger' : '' }}">
        ...
        <input type="text" name="satuan" id="input-satuan" class="form-control form-control-alternative{{ $errors->has('satuan') ? ' is-invalid' : '' }}" placeholder="{{ __('Satuan') }}" value="{{$barang->satuan}}" required>
