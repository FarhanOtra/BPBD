<div class="form-group{{ $errors->has('id_barang') ? ' has-danger' : '' }}">
    ...
    <div class="form-group{{ $errors->has('deskripsi') ? ' has-danger' : '' }}">
        ...
        <textarea type="text" name="deskripsi" id="input-deskripsi" class="form-control form-control-alternative{{ $errors->has('deskripsi') ? ' is-invalid' : '' }}" placeholder="{{ __('Deskripsi') }}" rows="3" >{{$barang->deskripsi}}</textarea>
