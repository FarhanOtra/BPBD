              ...
              <table id="table" class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="budget">Asal Bantuan</th>
                ...
                @foreach($rekapmasuk as $b)
                  <tr>
                    ...
                    <?php 
                        ...
                        $hari = strftime("%A", strtotime($b->berita_masuk->tanggal));
                        // $hari = strftime("%D", $tanggal);
                        // $hari = date('a',$tanggal);
                        $tgl = date('d',$tanggal);
                        // $bulan = date('m',$tanggal);
                        $bulan = strftime("%B", strtotime($b->berita_masuk->tanggal));
                        // $tahun = date('y',$tanggal);
                        $tahun = strftime("%Y", strtotime($b->berita_masuk->tanggal));
                            // $tanggal = strtotime($b->berita_masuk->tanggal)
                    // ?>
                    ...
                    <?php 
                        setlocale(LC_ALL, 'id-ID', 'id_ID');
                        $tanggal = strtotime($b->exp);
                        $hari = strftime("%A", strtotime($b->exp));
                        // $hari = strftime("%D", $tanggal);
                        // $hari = date('a',$tanggal);
                        $tgl = date('d',$tanggal);
                        // $bulan = date('m',$tanggal);
                        $bulan = strftime("%B", strtotime($b->exp));
                        // $tahun = date('y',$tanggal);
                        $tahun = strftime("%Y", strtotime($b->exp));
                            // $tanggal = strtotime($b->exp)
                    // ?>
